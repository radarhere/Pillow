    ...
    "libjxl": {
        ...
        "build": [
            *cmds_cmake(
                ...
                '-DCMAKE_C_FLAGS="/MD -DJXL_STATIC_DEFINE -DJXL_CMS_STATIC_DEFINE -DJXL_THREADS_STATIC_DEFINE"',
                '-DCMAKE_CXX_FLAGS="/MD -DJXL_STATIC_DEFINE -DJXL_CMS_STATIC_DEFINE -DJXL_THREADS_STATIC_DEFINE"',
