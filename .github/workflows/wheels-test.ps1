...
dir
dir build
dir build/lib.win-amd64-cpython-310/PIL
./Dependencies_x64_Release/Dependencies.exe -depth 1 -imports ./build/lib.win-amd64-cpython-310/PIL/_jpegxl.cp310-win_amd64.pyd
