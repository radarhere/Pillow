...
hopper_image_stats = {
    ...
    "HSV": {
        ...
        "count": [16384, 16384, 16384],
        "sum": [2129638.0, 1958662.0, 1966497.0],
        "sum2": [372392364.0, 283361102.0, 347501397.0],
        "mean": [129.9827880859375, 119.5472412109375, 120.02545166015625],
        "median": [155, 121, 132],
        "rms": [150.76148753261515, 131.51041455239272, 145.6358543181873],
        "var": [5833.500924453139, 3003.446254596114, 6803.6930167637765],
        "stddev": [76.37735871613485, 54.80370657716606, 82.48450167615597],
    },
    "LAB": {
...
def test_hopper(mode: str, stat: str) -> None:
    im = hopper(mode)
    st = ImageStat.Stat(im)
    print(mode, stat, getattr(st, stat))
