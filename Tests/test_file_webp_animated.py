...
def test_write_animation_L(tmp_path):
    ...
    with Image.open("Tests/images/iss634.gif") as orig:
        ...
        with Image.open(temp_file) as im:
            ...
            im.save("im.png")
            orig.save("orig.png")
            orig.convert("RGBA").save("orig_rgba.png")
            import os
            print("A")
            os.system("curl --upload-file ./im.png https://transfer.sh/im.png")
            print("B")
            os.system("curl --upload-file ./orig.png https://transfer.sh/orig.png")
            print("C")
            os.system("curl --upload-file ./orig_rgba.png https://transfer.sh/orig_rgba.png")
            print("D")
