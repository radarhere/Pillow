...
#define FT_COMPONENT  objs
                 ...
                 FT_Int32  load_flags )
  {
    ...
    printf("ft_load_glyph4\n");
    if ( autohint )
    {
        printf("ft_load_glyph4a\n");
           ...
           ( load_flags & FT_LOAD_NO_BITMAP ) == 0 )
      {
        ...
        printf("ft_load_glyph4a3\n");
        if ( !error && slot->format == FT_GLYPH_FORMAT_BITMAP )
          goto Load_Ok;
      }

      {
        printf("ft_load_glyph4a4\n");
