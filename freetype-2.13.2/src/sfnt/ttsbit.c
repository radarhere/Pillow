...
#define FT_COMPONENT  ttsbit
  ...
  retry:
    ...
    printf("graphictype %d\n", graphicType); // 666C6970 - flip
    ...
    default:
      printf("other %d\n", graphicType); // 666C6970 - flip
      printf("match %d\n", FT_MAKE_TAG( 'f', 'l', 'i', 'p' ));
      printf("cdef %#08x\n", FT_MAKE_TAG( 'c', 'd', 'e', 'f' )); // 7267626C
      printf("ghij %#08x\n", FT_MAKE_TAG( 'g', 'h', 'i', 'j' )); // 7267626C
      printf("lmno %#08x\n", FT_MAKE_TAG( 'l', 'm', 'n', 'o' )); // 7267626C
      printf("pqrs %#08x\n", FT_MAKE_TAG( 'p', 'q', 'r', 's' )); // 61626364
      error = FT_THROW( Unimplemented_Feature );
      break;
    }
