...
ImagingResampleInner(
    ...
    int horizontal_first = imIn->xsize >= xsize && imIn->ysize >= ysize && (imIn->xsize - xsize) > (imIn->ysize - ysize) * 2;
    printf("(%d - %d) > (%d - %d) * 2\n", imIn->xsize, xsize, imIn->ysize, ysize);
    printf(horizontal_first ? "horizontal\n" : "vertical\n");
